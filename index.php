            ...
            <div class="card-body">
              ...
              <form id="login-form" method="post" action="php/login.php">
                ...
                <input type="submit" name="login" id="login" class="btn btn-block login-btn mb-4" type="button"
                  value="Login">
                <a href="Pages/forgotpass.php" class="forgot-password-link">Forgot password?</a>
                <br><br>
...
//TODO players zabbit some echo mawjud
//TODO home page badda tuzbit
//TODO navigation bar baddu tuzbit lal tickets w merchandise, w kemn l editing profile lezim 3a 2e5ir l yamin
//TODO zabbit l shop menu bl navigation bar
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (response == "ok-fan") {
              ...
              myAlert('Email not registered with us', 'Pages/signup.html', 'Sign up',true);
            }
            else if (response == "incorrect") {
              myAlert('Email and Password do not match', 'index.php', 'Try again',false);
            }
            else if (response == "nothing") {
              myAlert('Please fill all fields', 'index.php', 'OK',false);
            }
          }
        });
      });
