        ...
        $('#login').click(function (e) {
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              if (response == "sent") {
                myAlert('Password reset link was sent to your email', '../index.php', 'Return',true);
              }
              else if (response == "no-email") {
                myAlert('Your email is not registered with us', 'signup.html', 'Sign up',true);
              }
              else{
                myAlert('Please fill your email','forgotpass.php','OK',false);
              }
            }
          });
        });
