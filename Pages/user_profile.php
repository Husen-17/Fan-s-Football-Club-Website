...
<body style="background: #181818;">
  ...
  font-size: 16px;
  resize: none;background:#5a5959;" name="bio" type="text" class="form-control bio" id="bio"
                                            placeholder="Bio"><?php echo htmlspecialchars($bio ?? '', ENT_QUOTES); ?></textarea>
                                    </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="text-right">
                                        <button style="background-color:red;"
                                            onclick="window.location.href='../php/signout.php'" type="button"
                                            id="submit" name="submit" class="btn btn-secondary">Sign
                                            Out</button>
                                        <button style="margin-left:12px;" onclick="window.location.href='home.php'"
                                            type="button" id="submit" name="submit"
                                            class="btn btn-secondary">Cancel</button>
                                        <button style="margin-left:12px;" type="submit" type="submit" id="login"
                                            name="login" class="btn btn-primary">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
