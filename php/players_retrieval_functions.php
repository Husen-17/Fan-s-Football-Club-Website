      ...
      <table class="table">
        ...
        <tr>
          ...
          <td>
            <?php
            // Get player age
            getPlayerAge($PLAYER_NUMBER, $tableName) ?>
          </td>
        </tr>
        <tr>
          <th>Email:</th>
          <td>
            <?php
            // Get player email
            getPlayerProperty($PLAYER_NUMBER, 'EMAIL', $tableName) ?>
          </td>
        </tr>
        <tr>
          <th>Nationality:</th>
          <td>
            ...
            getPlayerProperty($PLAYER_NUMBER, 'NATIONALITY', $tableName) ?>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            getPlayerProperty($PLAYER_NUMBER, 'INJURYHISTORY', $tableName) ?>
          </td>
        </tr>
        <tr>
          <th>Height:</th>
          <td>
            <?php
            // Get player height
            getPlayerProperty($PLAYER_NUMBER, 'HEIGHT', $tableName) ?> m
          </td>
        </tr>
        <tr>
          <th>Weight:</th>
          <td>
            <?php
            // Get player weight
            getPlayerProperty($PLAYER_NUMBER, 'WEIGHT', $tableName) ?> lbs
          </td>
        </tr>
        <?php
        ...
        if ($tableName == "goalkeepers_table") {
          ...
          <tr>
            ...
            <td>
              <?php
              // Get player pace
              getPlayerProperty($PLAYER_NUMBER, 'PACE', $tableName) ?>
            </td>
          </tr>
          <tr>
            <th>SHOOTING:</th>
            <td>
              <?php
              // Get player shooting
              getPlayerProperty($PLAYER_NUMBER, 'SHOOTING', $tableName) ?>
            </td>
          </tr>
          <tr>
            <th>PASSING:</th>
            <td>
              <?php
              // Get player passing
              getPlayerProperty($PLAYER_NUMBER, 'PASSING', $tableName) ?>
            </td>
          </tr>
          <tr>
            <th>PHYSICALITY:</th>
            <td>
              ...
              getPlayerProperty($PLAYER_NUMBER, 'PHYSICALITY', $tableName) ?>
            </td>
          </tr>
          <tr>
            <th>HEADING:</th>
            <td>
              <?php
              // Get player heading
              getPlayerProperty($PLAYER_NUMBER, 'HEADING', $tableName) ?>
            </td>
          </tr>
          <tr>
            <th>COMPOSURE:</th>
            <td>
              ...
              getPlayerProperty($PLAYER_NUMBER, 'COMPOSURE', $tableName) ?>
            </td>
          </tr>
          <tr>
            <th>OTHER FAVORITE POSITIONS:</th>
            <td>
              <?php getPlayerProperty($PLAYER_NUMBER, 'OTHERFAVORITEPOSITIONS', $tableName) ?>
            </td>
          </tr>
          <tr>
          <?php } ?>
          ...
          <td>
            <?php getPlayerProperty($PLAYER_NUMBER, 'COMMUNICATIONSKILLS', $tableName) ?>
          </td>
        </tr>
        <tr>
          <th>Leadership Skills</th>
          <td>
            <?php getPlayerProperty($PLAYER_NUMBER, 'LEADERSHIPSKILLS', $tableName) ?>
          </td>
        </tr>
      </table>
    </div>
    <button class="secondary-button" style="display: inline-flex;
  align-items: center;
  padding: 10px 20px;
...
"><a style="text-decoration:none;color:white;" href=  <?php echo $page ?>>Back</a></button>
  </body>
...
{ ?>
  ...
  font-size: 14px;
  margin:20px;margin-top:10px;
"><a style="text-decoration:none;color:white;" href= ../team.php >Back</a></button>
  <?php
}
/**
...
{ ?>
  <div class="players-container">
    <div class="player">
      ...
      imageLink($player_number, $tableName) ?>
        alt="Player Image">
      <div class="player-info">
        ...
        <a class="view-details"
          href="ViewDetails.php?token=<?php echo $player_number ?>&my_table=<?php echo $tableName ?>&page=<?php echo $page ?>">View
          Details</a>
      </div>
    </div>
  </div>
...
function keeperPart($PLAYER_NUMBER, $tableName)
{
  ...
  <tr>
    ...
    <td>
      ...
      getPlayerProperty($PLAYER_NUMBER, 'DIVING', $tableName) ?>
    </td>
  </tr>
  <tr>
    <th>Handling:</th>
    <td>
      ...
      getPlayerProperty($PLAYER_NUMBER, 'HANDLING', $tableName) ?>
    </td>
  </tr>
  <tr>
    <th>Kicking:</th>
    <td>
      ...
      getPlayerProperty($PLAYER_NUMBER, 'KICKING', $tableName) ?>
    </td>
  ...
  <tr>
    <th>Reflexes:</th>
    <td>
      <?php getPlayerProperty($PLAYER_NUMBER, 'REFLEXES', $tableName) ?>
    </td>
  </tr>
  <tr>
    <th>Speed:</th>
    <td>
      <?php getPlayerProperty($PLAYER_NUMBER, 'SPEED', $tableName) ?>
    </td>
  </tr>
  <tr>
    <th>Positioning:</th>
    <td>
      <?php getPlayerProperty($PLAYER_NUMBER, 'POSITIONING', $tableName) ?>
    </td>
  </tr>
  <tr>
    <?php
