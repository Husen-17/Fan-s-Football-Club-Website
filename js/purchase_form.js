...
form.addEventListener('submit', function(event) {
    ...
    var x = document.getElementById("pcart1").value;
    ...
    //parsing the payment in points to numebr
    var pt = Number((points*50)/200);
    ...
    //check if the amount paid by the fan between cash and points(200 points===50$) is equal to the amount that should be paid (i.e. cart)
    if(p+pt!=y){
...
returnButton.addEventListener('click', function() {
    window.location.href = '../Pages/Merchandise.php';
});